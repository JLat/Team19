...
public class LCD implements TimerListener {
	public static final int LCD_REFRESH = 100;
	private Odometer odo;
	private Timer lcdTimer;
	private TextLCD LCD = LocalEV3.get().getTextLCD();
	private USSController USS;
	private LightController lSensor;
	...
	public LCD(Odometer odo, USSController USS, LightController lSensor) {
		this.USS = USS;
