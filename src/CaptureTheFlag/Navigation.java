...
//	}
	...
	/*
	 *convertAngle: takes in the robot's specs (wheel radius and track width) to compute the angle to turn 
	 */
	private int convertAngleDegrees(double radius, double width, double angle) {
